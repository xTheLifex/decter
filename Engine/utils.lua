...
function utils.Color(red, green, blue)
	local r = red or 0
	local g = green or 0
	local b = blue or 0

	if (istable(red)) then
		-- Then "red" is actually a color table someone is trying to convert.
		r = red[1]
		g = red[2]
		b = red[3]
	end
